	...
	<body>
		...
		<script>
			function clearFilters() {
				...
				box.value = "";
				var box = document.getElementById('discountFilter');
				box.value = "";
			}
		</script>
		<div class="container">
		...
		<div class="breadcrumbs"><a href="index.php">Home</a> > Customers</div>
		<br>
		<br>
			...
			<tr>
				<form id="filters" method="POST">
					...
					<td>
						<center>
							Loyalty Points
							<input name="pointsFilter" value="" placeholder="Filter Points" type="number" id="pointsFilter">
						</center>
					</td>	
				</form>
			</tr>
		...
		if ($_SESSION['loggedin']){
				...
				$sql="SELECT name, customerStartDate, loyaltyPoints  FROM customer";
				...
				if( isset($_POST['pointsFilter'])  && $_POST['pointsFilter'] != null ) {
					$sql .= ' AND loyaltyPoints = ';
					$sql .= $_POST['pointsFilter'];
				}
