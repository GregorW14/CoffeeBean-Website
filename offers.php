...
<html>
	...
	<body>
		...
		<div class="breadcrumbs"><a href="index.php">Home</a> > Offers</div>
		<br>
		<br>
			...
			<tr>
				<form id="filters" method="POST">
					...
					<td>
						<center>
							Discount
							<input name="discountFilter" value="" placeholder="Filter Discount" type="number" id="discountFilter">
						</center>
					</td>	
				</form>
			</tr>
		...
		if ($_SESSION['loggedin']){
				...
				$sql="SELECT name, discount, startDate, endDate, description FROM offer";
				...
				if( isset($_POST['discountFilter'])  && $_POST['discountFilter'] != null ) {
					$sql .= ' AND discount = ';
					$sql .= $_POST['discountFilter'];
				}
